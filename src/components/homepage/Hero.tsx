      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-text-primary leading-[1.15]">
            ...
            {/* Micro Benefits List */}
            <div className="pt-4 grid grid-cols-1 sm:grid-cols-3 gap-3 w-full border-t border-border mt-6">
        ...
        {/* Brand logos row */}
        <div className="mt-16 border-t border-border-light pt-8 text-center">
